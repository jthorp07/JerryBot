...
function pickMap(con, queueId, trans) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!con.connected)
            return new errors_1.NotConnectedError("PickMap");
        if (!queueId)
            return new errors_1.NullArgError(["QueueId"], "PickMap");
