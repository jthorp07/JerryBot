...
function getMapSidePickId(con, userId, queueId, trans) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield req.input("UserId", (0, mssql_1.VarChar)(21))
            ...
            .prepare("SELECT MapSidePickId FROM Queues WHERE [Id]=@QueueId AND MapSidePickId=@UserId");
...
exports.default = getMapSidePickId;
